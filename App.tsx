    ...
    if (isSubScreen) {
        return (
            <header className="bg-light-bg dark:bg-dark-bg p-4 flex items-center justify-between sticky top-0 z-20 h-16 border-b border-gray-200 dark:border-gray-800 transition-colors shadow-sm md:px-8 relative">
                {/* Robust Centering: Title is placed in an absolute layer to ensure perfect centering */}
                <div className="absolute inset-0 flex items-center justify-center pointer-events-none px-16">
                    <h1 className="keep-animating w-full text-center truncate text-[1.12rem] font-black text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary tracking-widest uppercase animate-smart-pop-in drop-shadow-[0_1px_1px_rgba(0,0,0,0.1)]">
                        {titleMap[screen]}
                    </h1>
                </div>
