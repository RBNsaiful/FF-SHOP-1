...
const PurchaseModal: FC<PurchaseModalProps> = ({ offer, onClose, onConfirm, onSuccess, texts, userBalance, defaultUid, onInsufficientBalanceClick }) => {
  ...
  const handleInsufficientClick = () => {
      // Logic: Price - Balance = Required amount
