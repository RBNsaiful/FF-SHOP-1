        ...
        >
            ...
            `}>
                ...
                <div className="w-full mt-1 flex flex-col items-center">
                    ...
                    <button 
                        onClick={onBuy} 
                        className={`w-full text-white font-black uppercase tracking-wider ${s.btnSize} rounded-lg transition-all active:scale-95 shadow-lg 
                        ${isSpecial 
...
const HomeScreen: FC<HomeScreenProps> = ({ user, texts, onPurchase, diamondOffers, levelUpPackages, memberships, premiumApps, specialOffers = [], onNavigate, bannerImages, visibility, homeAdActive, homeAdCode, uiSettings, onInsufficientBalance }) => {
